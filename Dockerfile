...
RUN echo "alias cbp='colcon build --symlink-install --packages-select'" >> /root/.zshrc
...
RUN echo "alias r2pc='ros2 pkg create'" >> /root/.zshrc
RUN echo "alias r2pcpy='ros2 pkg create --build-type ament_python'" >> /root/.zshrc
RUN echo "alias r2is='ros2 interface show'" >> /root/.zshrc
RUN echo "alias r2l='ros2 launch'" >> /root/.zshrc